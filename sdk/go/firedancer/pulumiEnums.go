...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*VariantInput)(nil)).Elem(), Variant("frankendancer"))
	pulumi.RegisterInputType(reflect.TypeOf((*VariantPtrInput)(nil)).Elem(), Variant("frankendancer"))
