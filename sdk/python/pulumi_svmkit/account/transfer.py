...
class TransferArgs:
    ...
    def recipient_pubkey(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "recipient_pubkey")

    @recipient_pubkey.setter
    def recipient_pubkey(self, value: pulumi.Input[builtins.str]):
    ...
    def allow_unfunded_recipient(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "allow_unfunded_recipient")

    @allow_unfunded_recipient.setter
    def allow_unfunded_recipient(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Transfer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowUnfundedRecipient")
    def allow_unfunded_recipient(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "allow_unfunded_recipient")
    ...
    @property
    @pulumi.getter(name="recipientPubkey")
    def recipient_pubkey(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "recipient_pubkey")
