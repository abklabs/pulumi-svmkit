...
class VoteAccountArgs:
    def __init__(__self__, *,
                 ...
                 auth_voter_pubkey: Optional[pulumi.Input[_builtins.str]] = None,
                 close_recipient_pubkey: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def auth_voter_pubkey(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "auth_voter_pubkey")

    @auth_voter_pubkey.setter
    def auth_voter_pubkey(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "auth_voter_pubkey", value)

    @_builtins.property
    @pulumi.getter(name="closeRecipientPubkey")
    def close_recipient_pubkey(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "close_recipient_pubkey")

    @close_recipient_pubkey.setter
    def close_recipient_pubkey(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class VoteAccount(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authVoterPubkey")
    def auth_voter_pubkey(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "auth_voter_pubkey")

    @_builtins.property
    @pulumi.getter(name="closeRecipientPubkey")
    def close_recipient_pubkey(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "close_recipient_pubkey")
