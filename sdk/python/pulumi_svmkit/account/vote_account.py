...
class VoteAccountArgs:
    ...
    def auth_voter_pubkey(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "auth_voter_pubkey")

    @auth_voter_pubkey.setter
    def auth_voter_pubkey(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auth_voter_pubkey", value)

    @property
    @pulumi.getter(name="closeRecipientPubkey")
    def close_recipient_pubkey(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "close_recipient_pubkey")

    @close_recipient_pubkey.setter
    def close_recipient_pubkey(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VoteAccount(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="authVoterPubkey")
    def auth_voter_pubkey(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "auth_voter_pubkey")

    @property
    @pulumi.getter(name="closeRecipientPubkey")
    def close_recipient_pubkey(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "close_recipient_pubkey")
