...
if not MYPY:
    class EnvironmentArgsDict(TypedDict):
        rpc_url: pulumi.Input[builtins.str]
elif False:
...
class EnvironmentArgs:
    ...
    def rpc_url(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "rpc_url")

    @rpc_url.setter
    def rpc_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rpc_url", value)


if not MYPY:
    class StakeAccountKeyPairsArgsDict(TypedDict):
        stake_account: pulumi.Input[builtins.str]
...
class StakeAccountKeyPairsArgs:
    ...
    def stake_account(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "stake_account")

    @stake_account.setter
    def stake_account(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class TxnOptionsArgsDict(TypedDict):
        block_hash: NotRequired[pulumi.Input[builtins.str]]
        commitment: NotRequired[pulumi.Input[builtins.str]]
        fee_payer: NotRequired[pulumi.Input[builtins.str]]
        from_: NotRequired[pulumi.Input[builtins.str]]
        key_pair: NotRequired[pulumi.Input[builtins.str]]
        nonce: NotRequired[pulumi.Input[builtins.str]]
        nonce_authority: NotRequired[pulumi.Input[builtins.str]]
        signer: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        url: NotRequired[pulumi.Input[builtins.str]]
        with_compute_unit_price: NotRequired[pulumi.Input[builtins.float]]
        with_memo: NotRequired[pulumi.Input[builtins.str]]
        ws: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class TxnOptionsArgs:
    def __init__(__self__, *,
                 block_hash: Optional[pulumi.Input[builtins.str]] = None,
                 commitment: Optional[pulumi.Input[builtins.str]] = None,
                 fee_payer: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 nonce_authority: Optional[pulumi.Input[builtins.str]] = None,
                 signer: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None,
                 with_compute_unit_price: Optional[pulumi.Input[builtins.float]] = None,
                 with_memo: Optional[pulumi.Input[builtins.str]] = None,
                 ws: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def block_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "block_hash")

    @block_hash.setter
    def block_hash(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def fee_payer(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "fee_payer")

    @fee_payer.setter
    def fee_payer(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nonce_authority(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "nonce_authority")

    @nonce_authority.setter
    def nonce_authority(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nonce_authority", value)

    @property
    @pulumi.getter
    def signer(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "signer")

    @signer.setter
    def signer(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def with_compute_unit_price(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "with_compute_unit_price")

    @with_compute_unit_price.setter
    def with_compute_unit_price(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "with_compute_unit_price", value)

    @property
    @pulumi.getter(name="withMemo")
    def with_memo(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "with_memo")

    @with_memo.setter
    def with_memo(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "with_memo", value)

    @property
    @pulumi.getter
    def ws(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ws")

    @ws.setter
    def ws(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ValidatorInfoArgsDict(TypedDict):
        ...
        website: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
if not MYPY:
    class VoteAccountKeyPairsArgsDict(TypedDict):
        auth_withdrawer: pulumi.Input[builtins.str]
...
class VoteAccountKeyPairsArgs:
    ...
    def auth_withdrawer(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "auth_withdrawer")

    @auth_withdrawer.setter
    def auth_withdrawer(self, value: pulumi.Input[builtins.str]):
