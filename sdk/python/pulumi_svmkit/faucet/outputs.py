...
class FaucetFlags(dict):
    ...
    def __init__(__self__, *,
                 allow_ips: Optional[Sequence[builtins.str]] = None,
                 per_request_cap: Optional[builtins.int] = None,
                 per_time_cap: Optional[builtins.int] = None,
                 slice_seconds: Optional[builtins.int] = None):
