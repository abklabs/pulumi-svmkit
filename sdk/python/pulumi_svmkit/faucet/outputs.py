...
class FaucetFlags(dict):
    ...
    def __init__(__self__, *,
                 ...
                 per_request_cap: Optional[_builtins.int] = None,
                 per_time_cap: Optional[_builtins.int] = None,
                 slice_seconds: Optional[_builtins.int] = None):
    ...
    def per_request_cap(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "per_request_cap")

    @_builtins.property
    @pulumi.getter(name="perTimeCap")
    def per_time_cap(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "per_time_cap")

    @_builtins.property
    @pulumi.getter(name="sliceSeconds")
    def slice_seconds(self) -> Optional[_builtins.int]:
