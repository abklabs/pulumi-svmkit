...
if not MYPY:
    class TunerKernelParamsArgsDict(TypedDict):
        kernel_hung_task_timeout_secs: NotRequired[pulumi.Input[builtins.int]]
        kernel_nmi_watchdog: NotRequired[pulumi.Input[builtins.int]]
        kernel_pid_max: NotRequired[pulumi.Input[builtins.int]]
        kernel_sched_min_granularity_ns: NotRequired[pulumi.Input[builtins.int]]
        kernel_sched_wakeup_granularity_ns: NotRequired[pulumi.Input[builtins.int]]
        kernel_timer_migration: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class TunerKernelParamsArgs:
    def __init__(__self__, *,
                 kernel_hung_task_timeout_secs: Optional[pulumi.Input[builtins.int]] = None,
                 kernel_nmi_watchdog: Optional[pulumi.Input[builtins.int]] = None,
                 kernel_pid_max: Optional[pulumi.Input[builtins.int]] = None,
                 kernel_sched_min_granularity_ns: Optional[pulumi.Input[builtins.int]] = None,
                 kernel_sched_wakeup_granularity_ns: Optional[pulumi.Input[builtins.int]] = None,
                 kernel_timer_migration: Optional[pulumi.Input[builtins.int]] = None):
...
if not MYPY:
    class TunerNetParamsArgsDict(TypedDict):
        ...
        net_ipv4_tcp_congestion_control: NotRequired[pulumi.Input[builtins.str]]
        net_ipv4_tcp_fastopen: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_low_latency: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_moderate_rcvbuf: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_no_metrics_save: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_rmem: NotRequired[pulumi.Input[builtins.str]]
        net_ipv4_tcp_sack: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_timestamps: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_tw_reuse: NotRequired[pulumi.Input[builtins.int]]
        net_ipv4_tcp_wmem: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class TunerNetParamsArgs:
    def __init__(__self__, *,
                 ...
                 net_ipv4_tcp_congestion_control: Optional[pulumi.Input[builtins.str]] = None,
                 net_ipv4_tcp_fastopen: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_low_latency: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_moderate_rcvbuf: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_no_metrics_save: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_rmem: Optional[pulumi.Input[builtins.str]] = None,
                 net_ipv4_tcp_sack: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_timestamps: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_tw_reuse: Optional[pulumi.Input[builtins.int]] = None,
                 net_ipv4_tcp_wmem: Optional[pulumi.Input[builtins.str]] = None):
...
if not MYPY:
    class TunerVmParamsArgsDict(TypedDict):
        vm_dirty_background_ratio: NotRequired[pulumi.Input[builtins.int]]
        vm_dirty_expire_centisecs: NotRequired[pulumi.Input[builtins.int]]
        vm_dirty_ratio: NotRequired[pulumi.Input[builtins.int]]
        vm_dirty_writeback_centisecs: NotRequired[pulumi.Input[builtins.int]]
        vm_dirtytime_expire_seconds: NotRequired[pulumi.Input[builtins.int]]
        vm_max_map_count: NotRequired[pulumi.Input[builtins.int]]
        vm_min_free_kbytes: NotRequired[pulumi.Input[builtins.int]]
        vm_stat_interval: NotRequired[pulumi.Input[builtins.int]]
...
class TunerVmParamsArgs:
    def __init__(__self__, *,
                 vm_dirty_background_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 vm_dirty_expire_centisecs: Optional[pulumi.Input[builtins.int]] = None,
                 vm_dirty_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 vm_dirty_writeback_centisecs: Optional[pulumi.Input[builtins.int]] = None,
                 vm_dirtytime_expire_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 vm_max_map_count: Optional[pulumi.Input[builtins.int]] = None,
                 vm_min_free_kbytes: Optional[pulumi.Input[builtins.int]] = None,
                 vm_stat_interval: Optional[pulumi.Input[builtins.int]] = None,
    ...
    def vm_min_free_kbytes(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "vm_min_free_kbytes")

    @vm_min_free_kbytes.setter
    def vm_min_free_kbytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "vm_min_free_kbytes", value)

    @property
    @pulumi.getter(name="vmStatInterval")
    def vm_stat_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "vm_stat_interval")

    @vm_stat_interval.setter
    def vm_stat_interval(self, value: Optional[pulumi.Input[builtins.int]]):
