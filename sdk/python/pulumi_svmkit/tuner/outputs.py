...
class TunerKernelParams(dict):
    ...
    def __init__(__self__, *,
                 kernel_hung_task_timeout_secs: Optional[_builtins.int] = None,
                 kernel_nmi_watchdog: Optional[_builtins.int] = None,
                 kernel_pid_max: Optional[_builtins.int] = None,
                 kernel_sched_min_granularity_ns: Optional[_builtins.int] = None,
                 kernel_sched_wakeup_granularity_ns: Optional[_builtins.int] = None,
                 kernel_timer_migration: Optional[_builtins.int] = None):
...
class TunerNetParams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 net_ipv4_tcp_congestion_control: Optional[_builtins.str] = None,
                 net_ipv4_tcp_fastopen: Optional[_builtins.int] = None,
                 net_ipv4_tcp_low_latency: Optional[_builtins.int] = None,
                 net_ipv4_tcp_moderate_rcvbuf: Optional[_builtins.int] = None,
                 net_ipv4_tcp_no_metrics_save: Optional[_builtins.int] = None,
                 net_ipv4_tcp_rmem: Optional[_builtins.str] = None,
                 net_ipv4_tcp_sack: Optional[_builtins.int] = None,
                 net_ipv4_tcp_timestamps: Optional[_builtins.int] = None,
                 net_ipv4_tcp_tw_reuse: Optional[_builtins.int] = None,
                 net_ipv4_tcp_wmem: Optional[_builtins.str] = None):
...
class TunerVmParams(dict):
    ...
    def __init__(__self__, *,
                 vm_dirty_background_ratio: Optional[_builtins.int] = None,
                 vm_dirty_expire_centisecs: Optional[_builtins.int] = None,
                 vm_dirty_ratio: Optional[_builtins.int] = None,
                 vm_dirty_writeback_centisecs: Optional[_builtins.int] = None,
                 vm_dirtytime_expire_seconds: Optional[_builtins.int] = None,
                 vm_max_map_count: Optional[_builtins.int] = None,
                 vm_min_free_kbytes: Optional[_builtins.int] = None,
                 vm_stat_interval: Optional[_builtins.int] = None,
    ...
    def vm_min_free_kbytes(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "vm_min_free_kbytes")

    @_builtins.property
    @pulumi.getter(name="vmStatInterval")
    def vm_stat_interval(self) -> Optional[_builtins.int]:
