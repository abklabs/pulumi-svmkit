...
class TunerKernelParams(dict):
    ...
    def __init__(__self__, *,
                 kernel_hung_task_timeout_secs: Optional[builtins.int] = None,
                 kernel_nmi_watchdog: Optional[builtins.int] = None,
                 kernel_pid_max: Optional[builtins.int] = None,
                 kernel_sched_min_granularity_ns: Optional[builtins.int] = None,
                 kernel_sched_wakeup_granularity_ns: Optional[builtins.int] = None,
                 kernel_timer_migration: Optional[builtins.int] = None):
...
class TunerNetParams(dict):
    ...
    def __init__(__self__, *,
                 net_core_rmem_default: Optional[builtins.int] = None,
                 net_core_rmem_max: Optional[builtins.int] = None,
                 net_core_wmem_default: Optional[builtins.int] = None,
                 net_core_wmem_max: Optional[builtins.int] = None,
                 net_ipv4_tcp_congestion_control: Optional[builtins.str] = None,
                 net_ipv4_tcp_fastopen: Optional[builtins.int] = None,
                 net_ipv4_tcp_low_latency: Optional[builtins.int] = None,
                 net_ipv4_tcp_moderate_rcvbuf: Optional[builtins.int] = None,
                 net_ipv4_tcp_no_metrics_save: Optional[builtins.int] = None,
                 net_ipv4_tcp_rmem: Optional[builtins.str] = None,
                 net_ipv4_tcp_sack: Optional[builtins.int] = None,
                 net_ipv4_tcp_timestamps: Optional[builtins.int] = None,
                 net_ipv4_tcp_tw_reuse: Optional[builtins.int] = None,
                 net_ipv4_tcp_wmem: Optional[builtins.str] = None):
...
class TunerVmParams(dict):
    ...
    def __init__(__self__, *,
                 vm_dirty_background_ratio: Optional[builtins.int] = None,
                 vm_dirty_expire_centisecs: Optional[builtins.int] = None,
                 vm_dirty_ratio: Optional[builtins.int] = None,
                 vm_dirty_writeback_centisecs: Optional[builtins.int] = None,
                 vm_dirtytime_expire_seconds: Optional[builtins.int] = None,
                 vm_max_map_count: Optional[builtins.int] = None,
                 vm_min_free_kbytes: Optional[builtins.int] = None,
                 vm_stat_interval: Optional[builtins.int] = None,
                 vm_swappiness: Optional[builtins.int] = None):
