...
class BootstrapAccount(dict):
    ...
    def __init__(__self__, *,
                 ...
                 stake_pubkey: builtins.str,
                 vote_pubkey: builtins.str,
                 balance_lamports: Optional[builtins.int] = None,
                 stake_lamports: Optional[builtins.int] = None):
...
class GenesisFlags(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ledger_path: builtins.str,
                 bootstrap_stake_authorized_pubkey: Optional[builtins.str] = None,
                 bootstrap_validator_lamports: Optional[builtins.int] = None,
                 bootstrap_validator_stake_lamports: Optional[builtins.int] = None,
                 cluster_type: Optional[builtins.str] = None,
                 creation_time: Optional[builtins.str] = None,
                 deactivate_features: Optional[Sequence[builtins.str]] = None,
                 enable_warmup_epochs: Optional[builtins.bool] = None,
                 extra_flags: Optional[Sequence[builtins.str]] = None,
                 faucet_lamports: Optional[builtins.int] = None,
                 faucet_pubkey: Optional[builtins.str] = None,
                 fee_burn_percentage: Optional[builtins.int] = None,
                 hashes_per_tick: Optional[builtins.str] = None,
                 inflation: Optional[builtins.str] = None,
                 lamports_per_byte_year: Optional[builtins.int] = None,
                 max_genesis_archive_unpacked_size: Optional[builtins.int] = None,
                 rent_burn_percentage: Optional[builtins.int] = None,
                 rent_exemption_threshold: Optional[builtins.int] = None,
                 slots_per_epoch: Optional[builtins.int] = None,
                 target_lamports_per_signature: Optional[builtins.int] = None,
                 target_signatures_per_slot: Optional[builtins.int] = None,
                 target_tick_duration: Optional[builtins.int] = None,
                 ticks_per_slot: Optional[builtins.int] = None,
                 url: Optional[builtins.str] = None,
                 vote_commission_percentage: Optional[builtins.int] = None):
    ...
    def deactivate_features(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "deactivate_features")

    @property
    @pulumi.getter(name="enableWarmupEpochs")
    def enable_warmup_epochs(self) -> Optional[builtins.bool]:
    ...
    def vote_commission_percentage(self) -> Optional[builtins.int]:
...
class PrimordialAccount(dict):
    ...
    @property
    @pulumi.getter
    def lamports(self) -> builtins.int:
        return pulumi.get(self, "lamports")

    @property
    @pulumi.getter
    def pubkey(self) -> builtins.str:
