...
if not MYPY:
    class BootstrapAccountArgsDict(TypedDict):
        identity_pubkey: pulumi.Input[builtins.str]
        stake_pubkey: pulumi.Input[builtins.str]
        vote_pubkey: pulumi.Input[builtins.str]
        balance_lamports: NotRequired[pulumi.Input[builtins.int]]
        stake_lamports: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class BootstrapAccountArgs:
    def __init__(__self__, *,
                 ...
                 stake_pubkey: pulumi.Input[builtins.str],
                 vote_pubkey: pulumi.Input[builtins.str],
                 balance_lamports: Optional[pulumi.Input[builtins.int]] = None,
                 stake_lamports: Optional[pulumi.Input[builtins.int]] = None):
    ...
    def identity_pubkey(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "identity_pubkey")

    @identity_pubkey.setter
    def identity_pubkey(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "identity_pubkey", value)

    @property
    @pulumi.getter(name="stakePubkey")
    def stake_pubkey(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "stake_pubkey")

    @stake_pubkey.setter
    def stake_pubkey(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "stake_pubkey", value)

    @property
    @pulumi.getter(name="votePubkey")
    def vote_pubkey(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "vote_pubkey")

    @vote_pubkey.setter
    def vote_pubkey(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vote_pubkey", value)

    @property
    @pulumi.getter(name="balanceLamports")
    def balance_lamports(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "balance_lamports")

    @balance_lamports.setter
    def balance_lamports(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "balance_lamports", value)

    @property
    @pulumi.getter(name="stakeLamports")
    def stake_lamports(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "stake_lamports")

    @stake_lamports.setter
    def stake_lamports(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class GenesisFlagsArgsDict(TypedDict):
        ...
        ledger_path: pulumi.Input[builtins.str]
        bootstrap_stake_authorized_pubkey: NotRequired[pulumi.Input[builtins.str]]
        bootstrap_validator_lamports: NotRequired[pulumi.Input[builtins.int]]
        bootstrap_validator_stake_lamports: NotRequired[pulumi.Input[builtins.int]]
        cluster_type: NotRequired[pulumi.Input[builtins.str]]
        creation_time: NotRequired[pulumi.Input[builtins.str]]
        deactivate_features: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        enable_warmup_epochs: NotRequired[pulumi.Input[builtins.bool]]
        extra_flags: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        faucet_lamports: NotRequired[pulumi.Input[builtins.int]]
        faucet_pubkey: NotRequired[pulumi.Input[builtins.str]]
        fee_burn_percentage: NotRequired[pulumi.Input[builtins.int]]
        hashes_per_tick: NotRequired[pulumi.Input[builtins.str]]
        inflation: NotRequired[pulumi.Input[builtins.str]]
        lamports_per_byte_year: NotRequired[pulumi.Input[builtins.int]]
        max_genesis_archive_unpacked_size: NotRequired[pulumi.Input[builtins.int]]
        rent_burn_percentage: NotRequired[pulumi.Input[builtins.int]]
        rent_exemption_threshold: NotRequired[pulumi.Input[builtins.int]]
        slots_per_epoch: NotRequired[pulumi.Input[builtins.int]]
        target_lamports_per_signature: NotRequired[pulumi.Input[builtins.int]]
        target_signatures_per_slot: NotRequired[pulumi.Input[builtins.int]]
        target_tick_duration: NotRequired[pulumi.Input[builtins.int]]
        ticks_per_slot: NotRequired[pulumi.Input[builtins.int]]
        url: NotRequired[pulumi.Input[builtins.str]]
        vote_commission_percentage: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class GenesisFlagsArgs:
    def __init__(__self__, *,
                 ...
                 ledger_path: pulumi.Input[builtins.str],
                 bootstrap_stake_authorized_pubkey: Optional[pulumi.Input[builtins.str]] = None,
                 bootstrap_validator_lamports: Optional[pulumi.Input[builtins.int]] = None,
                 bootstrap_validator_stake_lamports: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_type: Optional[pulumi.Input[builtins.str]] = None,
                 creation_time: Optional[pulumi.Input[builtins.str]] = None,
                 deactivate_features: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enable_warmup_epochs: Optional[pulumi.Input[builtins.bool]] = None,
                 extra_flags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 faucet_lamports: Optional[pulumi.Input[builtins.int]] = None,
                 faucet_pubkey: Optional[pulumi.Input[builtins.str]] = None,
                 fee_burn_percentage: Optional[pulumi.Input[builtins.int]] = None,
                 hashes_per_tick: Optional[pulumi.Input[builtins.str]] = None,
                 inflation: Optional[pulumi.Input[builtins.str]] = None,
                 lamports_per_byte_year: Optional[pulumi.Input[builtins.int]] = None,
                 max_genesis_archive_unpacked_size: Optional[pulumi.Input[builtins.int]] = None,
                 rent_burn_percentage: Optional[pulumi.Input[builtins.int]] = None,
                 rent_exemption_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 slots_per_epoch: Optional[pulumi.Input[builtins.int]] = None,
                 target_lamports_per_signature: Optional[pulumi.Input[builtins.int]] = None,
                 target_signatures_per_slot: Optional[pulumi.Input[builtins.int]] = None,
                 target_tick_duration: Optional[pulumi.Input[builtins.int]] = None,
                 ticks_per_slot: Optional[pulumi.Input[builtins.int]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None,
                 vote_commission_percentage: Optional[pulumi.Input[builtins.int]] = None):
    ...
    def deactivate_features(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "deactivate_features")

    @deactivate_features.setter
    def deactivate_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "deactivate_features", value)

    @property
    @pulumi.getter(name="enableWarmupEpochs")
    def enable_warmup_epochs(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "enable_warmup_epochs")

    @enable_warmup_epochs.setter
    def enable_warmup_epochs(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def faucet_lamports(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "faucet_lamports")

    @faucet_lamports.setter
    def faucet_lamports(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "faucet_lamports", value)

    @property
    @pulumi.getter(name="faucetPubkey")
    def faucet_pubkey(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "faucet_pubkey")

    @faucet_pubkey.setter
    def faucet_pubkey(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "faucet_pubkey", value)

    @property
    @pulumi.getter(name="feeBurnPercentage")
    def fee_burn_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "fee_burn_percentage")

    @fee_burn_percentage.setter
    def fee_burn_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "fee_burn_percentage", value)

    @property
    @pulumi.getter(name="hashesPerTick")
    def hashes_per_tick(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "hashes_per_tick")

    @hashes_per_tick.setter
    def hashes_per_tick(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hashes_per_tick", value)

    @property
    @pulumi.getter
    def inflation(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "inflation")

    @inflation.setter
    def inflation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inflation", value)

    @property
    @pulumi.getter(name="lamportsPerByteYear")
    def lamports_per_byte_year(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "lamports_per_byte_year")

    @lamports_per_byte_year.setter
    def lamports_per_byte_year(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def vote_commission_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "vote_commission_percentage")

    @vote_commission_percentage.setter
    def vote_commission_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "vote_commission_percentage", value)


if not MYPY:
    class PrimordialAccountArgsDict(TypedDict):
        lamports: pulumi.Input[builtins.int]
        pubkey: pulumi.Input[builtins.str]
...
class PrimordialAccountArgs:
    ...
    @property
    @pulumi.getter
    def lamports(self) -> pulumi.Input[builtins.int]:
        return pulumi.get(self, "lamports")

    @lamports.setter
    def lamports(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "lamports", value)

    @property
    @pulumi.getter
    def pubkey(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "pubkey")

    @pubkey.setter
    def pubkey(self, value: pulumi.Input[builtins.str]):
