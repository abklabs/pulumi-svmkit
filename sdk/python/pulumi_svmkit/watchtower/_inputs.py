...
if not MYPY:
    class TwilioConfigArgsDict(TypedDict):
        ...
        from_number: pulumi.Input[_builtins.str]
        to_number: pulumi.Input[_builtins.str]
elif False:
...
class TwilioConfigArgs:
    ...
    def from_number(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "from_number")

    @from_number.setter
    def from_number(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "from_number", value)

    @_builtins.property
    @pulumi.getter(name="toNumber")
    def to_number(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "to_number")

    @to_number.setter
    def to_number(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "to_number", value)


if not MYPY:
    class WatchtowerFlagsArgsDict(TypedDict):
        validator_identity: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
        active_stake_alert_threshold: NotRequired[pulumi.Input[_builtins.int]]
        ignore_http_bad_gateway: NotRequired[pulumi.Input[_builtins.bool]]
        interval: NotRequired[pulumi.Input[_builtins.int]]
        minimum_validator_identity_balance: NotRequired[pulumi.Input[_builtins.int]]
        monitor_active_stake: NotRequired[pulumi.Input[_builtins.bool]]
        name_suffix: NotRequired[pulumi.Input[_builtins.str]]
        rpc_timeout: NotRequired[pulumi.Input[_builtins.int]]
...
class WatchtowerFlagsArgs:
    def __init__(__self__, *,
                 validator_identity: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 active_stake_alert_threshold: Optional[pulumi.Input[_builtins.int]] = None,
                 ignore_http_bad_gateway: Optional[pulumi.Input[_builtins.bool]] = None,
                 interval: Optional[pulumi.Input[_builtins.int]] = None,
                 minimum_validator_identity_balance: Optional[pulumi.Input[_builtins.int]] = None,
                 monitor_active_stake: Optional[pulumi.Input[_builtins.bool]] = None,
                 name_suffix: Optional[pulumi.Input[_builtins.str]] = None,
                 rpc_timeout: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def validator_identity(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "validator_identity")

    @validator_identity.setter
    def validator_identity(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "validator_identity", value)

    @_builtins.property
    @pulumi.getter(name="activeStakeAlertThreshold")
    def active_stake_alert_threshold(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "active_stake_alert_threshold")

    @active_stake_alert_threshold.setter
    def active_stake_alert_threshold(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "active_stake_alert_threshold", value)

    @_builtins.property
    @pulumi.getter(name="ignoreHttpBadGateway")
    def ignore_http_bad_gateway(self) -> Optional[pulumi.Input[_builtins.bool]]:
        return pulumi.get(self, "ignore_http_bad_gateway")

    @ignore_http_bad_gateway.setter
    def ignore_http_bad_gateway(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def minimum_validator_identity_balance(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "minimum_validator_identity_balance")

    @minimum_validator_identity_balance.setter
    def minimum_validator_identity_balance(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "minimum_validator_identity_balance", value)

    @_builtins.property
    @pulumi.getter(name="monitorActiveStake")
    def monitor_active_stake(self) -> Optional[pulumi.Input[_builtins.bool]]:
        return pulumi.get(self, "monitor_active_stake")

    @monitor_active_stake.setter
    def monitor_active_stake(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def rpc_timeout(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "rpc_timeout")

    @rpc_timeout.setter
    def rpc_timeout(self, value: Optional[pulumi.Input[_builtins.int]]):
