...
class TwilioConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 from_number: _builtins.str,
                 to_number: _builtins.str):
    ...
    def from_number(self) -> _builtins.str:
        return pulumi.get(self, "from_number")

    @_builtins.property
    @pulumi.getter(name="toNumber")
    def to_number(self) -> _builtins.str:
...
class WatchtowerFlags(dict):
    ...
    def __init__(__self__, *,
                 validator_identity: Sequence[_builtins.str],
                 active_stake_alert_threshold: Optional[_builtins.int] = None,
                 ignore_http_bad_gateway: Optional[_builtins.bool] = None,
                 interval: Optional[_builtins.int] = None,
                 minimum_validator_identity_balance: Optional[_builtins.int] = None,
                 monitor_active_stake: Optional[_builtins.bool] = None,
                 name_suffix: Optional[_builtins.str] = None,
                 rpc_timeout: Optional[_builtins.int] = None,
    ...
    def minimum_validator_identity_balance(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "minimum_validator_identity_balance")

    @_builtins.property
    @pulumi.getter(name="monitorActiveStake")
    def monitor_active_stake(self) -> Optional[_builtins.bool]:
    ...
    def rpc_timeout(self) -> Optional[_builtins.int]:
