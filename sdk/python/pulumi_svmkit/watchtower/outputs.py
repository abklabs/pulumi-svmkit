...
class TelegramConfig(dict):
    ...
    def bot_token(self) -> builtins.str:
...
class TwilioConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 from_number: builtins.str,
                 to_number: builtins.str):
    ...
    def from_number(self) -> builtins.str:
        return pulumi.get(self, "from_number")

    @property
    @pulumi.getter(name="toNumber")
    def to_number(self) -> builtins.str:
...
class WatchtowerFlags(dict):
    ...
    def __init__(__self__, *,
                 validator_identity: Sequence[builtins.str],
                 active_stake_alert_threshold: Optional[builtins.int] = None,
                 ignore_http_bad_gateway: Optional[builtins.bool] = None,
                 interval: Optional[builtins.int] = None,
                 minimum_validator_identity_balance: Optional[builtins.int] = None,
                 monitor_active_stake: Optional[builtins.bool] = None,
                 name_suffix: Optional[builtins.str] = None,
                 rpc_timeout: Optional[builtins.int] = None,
    ...
    def minimum_validator_identity_balance(self) -> Optional[builtins.int]:
        return pulumi.get(self, "minimum_validator_identity_balance")

    @property
    @pulumi.getter(name="monitorActiveStake")
    def monitor_active_stake(self) -> Optional[builtins.bool]:
    ...
    def rpc_timeout(self) -> Optional[builtins.int]:
