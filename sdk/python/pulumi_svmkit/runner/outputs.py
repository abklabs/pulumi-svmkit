...
class Config(dict):
    ...
    def __init__(__self__, *,
                 apt_lock_timeout: Optional[builtins.int] = None,
                 keep_payload: Optional[builtins.bool] = None,
    ...
    def apt_lock_timeout(self) -> Optional[builtins.int]:
        return pulumi.get(self, "apt_lock_timeout")

    @property
    @pulumi.getter(name="keepPayload")
    def keep_payload(self) -> Optional[builtins.bool]:
