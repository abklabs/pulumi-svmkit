...
if not MYPY:
    class ConfigArgsDict(TypedDict):
        apt_lock_timeout: NotRequired[pulumi.Input[builtins.int]]
        keep_payload: NotRequired[pulumi.Input[builtins.bool]]
...
class ConfigArgs:
    def __init__(__self__, *,
                 apt_lock_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 keep_payload: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def apt_lock_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "apt_lock_timeout")

    @apt_lock_timeout.setter
    def apt_lock_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "apt_lock_timeout", value)

    @property
    @pulumi.getter(name="keepPayload")
    def keep_payload(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "keep_payload")

    @keep_payload.setter
    def keep_payload(self, value: Optional[pulumi.Input[builtins.bool]]):
