...
class ExplorerArgs:
    def __init__(__self__, *,
                 ...
                 rpcurl: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def rpcurl(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "rpcurl")

    @rpcurl.setter
    def rpcurl(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Explorer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="RPCURL")
    def rpcurl(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "rpcurl")
    ...
    @_builtins.property
    @pulumi.getter
    def symbol(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "symbol")
