...
if not MYPY:
    class FirewallParamsArgsDict(TypedDict):
        allow_ports: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
elif False:
...
class FirewallParamsArgs:
    ...
    def allow_ports(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "allow_ports")

    @allow_ports.setter
    def allow_ports(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
