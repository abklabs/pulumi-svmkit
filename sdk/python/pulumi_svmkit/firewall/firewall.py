...
class FirewallArgs:
    ...
    @property
    @pulumi.getter
    def params(self) -> pulumi.Input['FirewallParamsArgs']:
        return pulumi.get(self, "params")

    @params.setter
    def params(self, value: pulumi.Input['FirewallParamsArgs']):
...
class Firewall(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def params(self) -> pulumi.Output['outputs.FirewallParams']:
        return pulumi.get(self, "params")
