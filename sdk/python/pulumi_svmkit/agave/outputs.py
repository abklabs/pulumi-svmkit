...
class Flags(dict):
    ...
    def __init__(__self__, *,
                 no_wait_for_vote_to_start_leader: builtins.bool,
                 rpc_bind_address: builtins.str,
                 rpc_port: builtins.int,
                 wal_recovery_mode: builtins.str,
                 account_index: Optional[Sequence[builtins.str]] = None,
                 account_index_exclude_key: Optional[Sequence[builtins.str]] = None,
                 account_index_include_key: Optional[Sequence[builtins.str]] = None,
                 account_shrink_path: Optional[Sequence[builtins.str]] = None,
                 accounts_db_cache_limit_mb: Optional[builtins.int] = None,
                 accounts_db_test_hash_calculation: Optional[builtins.bool] = None,
                 accounts_hash_cache_path: Optional[builtins.str] = None,
                 accounts_index_bins: Optional[builtins.int] = None,
                 accounts_index_path: Optional[Sequence[builtins.str]] = None,
                 accounts_index_scan_results_limit_mb: Optional[builtins.int] = None,
                 accounts_shrink_optimize_total_space: Optional[builtins.bool] = None,
                 accounts_shrink_ratio: Optional[builtins.str] = None,
                 allow_private_addr: Optional[builtins.bool] = None,
                 authorized_voter: Optional[Sequence[builtins.str]] = None,
                 bind_address: Optional[builtins.str] = None,
                 block_production_method: Optional[builtins.str] = None,
                 block_verification_method: Optional[builtins.str] = None,
                 check_vote_account: Optional[builtins.str] = None,
                 contact_debug_interval: Optional[builtins.int] = None,
                 cuda: Optional[builtins.bool] = None,
                 debug_key: Optional[Sequence[builtins.str]] = None,
                 dev_halt_at_slot: Optional[builtins.int] = None,
                 disable_banking_trace: Optional[builtins.bool] = None,
                 dynamic_port_range: Optional[builtins.str] = None,
                 enable_banking_trace: Optional[builtins.int] = None,
                 enable_bigtable_ledger_upload: Optional[builtins.bool] = None,
                 enable_extended_tx_metadata_storage: Optional[builtins.bool] = None,
                 enable_rpc_bigtable_ledger_storage: Optional[builtins.bool] = None,
                 enable_rpc_transaction_history: Optional[builtins.bool] = None,
                 entry_point: Optional[Sequence[builtins.str]] = None,
                 etcd_cacert_file: Optional[builtins.str] = None,
                 etcd_cert_file: Optional[builtins.str] = None,
                 etcd_domain_name: Optional[builtins.str] = None,
                 etcd_endpoint: Optional[Sequence[builtins.str]] = None,
                 etcd_key_file: Optional[builtins.str] = None,
                 expected_bank_hash: Optional[builtins.str] = None,
                 expected_genesis_hash: Optional[builtins.str] = None,
                 expected_shred_version: Optional[builtins.int] = None,
                 extra_flags: Optional[Sequence[builtins.str]] = None,
                 full_rpc_api: Optional[builtins.bool] = None,
                 full_snapshot_archive_path: Optional[builtins.str] = None,
                 full_snapshot_interval_slots: Optional[builtins.int] = None,
                 geyser_plugin_always_enabled: Optional[builtins.bool] = None,
                 geyser_plugin_config: Optional[Sequence[builtins.str]] = None,
                 gossip_host: Optional[builtins.str] = None,
                 gossip_port: Optional[builtins.int] = None,
                 gossip_validator: Optional[Sequence[builtins.str]] = None,
                 hard_fork: Optional[Sequence[builtins.int]] = None,
                 health_check_slot_distance: Optional[builtins.int] = None,
                 incremental_snapshot_archive_path: Optional[builtins.str] = None,
                 init_complete_file: Optional[builtins.str] = None,
                 known_validator: Optional[Sequence[builtins.str]] = None,
                 limit_ledger_size: Optional[builtins.int] = None,
                 log: Optional[builtins.str] = None,
                 log_messages_bytes_limit: Optional[builtins.int] = None,
                 max_genesis_archive_unpacked_size: Optional[builtins.int] = None,
                 maximum_full_snapshots_to_retain: Optional[builtins.int] = None,
                 maximum_incremental_snapshots_to_retain: Optional[builtins.int] = None,
                 maximum_local_snapshot_age: Optional[builtins.int] = None,
                 maximum_snapshot_download_abort: Optional[builtins.int] = None,
                 minimal_snapshot_download_speed: Optional[builtins.int] = None,
                 no_genesis_fetch: Optional[builtins.bool] = None,
                 no_incremental_snapshots: Optional[builtins.bool] = None,
                 no_snapshot_fetch: Optional[builtins.bool] = None,
                 no_voting: Optional[builtins.bool] = None,
                 only_known_rpc: Optional[builtins.bool] = None,
                 private_rpc: Optional[builtins.bool] = None,
                 public_rpc_address: Optional[builtins.str] = None,
                 public_tpu_address: Optional[builtins.str] = None,
                 public_tpu_forwards_address: Optional[builtins.str] = None,
                 repair_validator: Optional[Sequence[builtins.str]] = None,
                 require_tower: Optional[builtins.bool] = None,
                 restricted_repair_only_mode: Optional[builtins.bool] = None,
                 rocksdb_fifo_shred_storage_size: Optional[builtins.int] = None,
                 rocksdb_shred_compaction: Optional[builtins.str] = None,
                 rpc_bigtable_app_profile_id: Optional[builtins.str] = None,
                 rpc_bigtable_instance_name: Optional[builtins.str] = None,
                 rpc_bigtable_max_message_size: Optional[builtins.int] = None,
                 rpc_bigtable_timeout: Optional[builtins.int] = None,
                 rpc_faucet_address: Optional[builtins.str] = None,
                 rpc_max_multiple_accounts: Optional[builtins.int] = None,
                 rpc_max_request_body_size: Optional[builtins.int] = None,
                 rpc_niceness_adjustment: Optional[builtins.int] = None,
                 rpc_pubsub_enable_block_subscription: Optional[builtins.bool] = None,
                 rpc_pubsub_enable_vote_subscription: Optional[builtins.bool] = None,
                 rpc_pubsub_max_active_subscriptions: Optional[builtins.int] = None,
                 rpc_pubsub_notification_threads: Optional[builtins.int] = None,
                 rpc_pubsub_queue_capacity_bytes: Optional[builtins.int] = None,
                 rpc_pubsub_queue_capacity_items: Optional[builtins.int] = None,
                 rpc_pubsub_worker_threads: Optional[builtins.int] = None,
                 rpc_scan_and_fix_roots: Optional[builtins.bool] = None,
                 rpc_send_leader_count: Optional[builtins.int] = None,
                 rpc_send_retry_ms: Optional[builtins.int] = None,
                 rpc_send_service_max_retries: Optional[builtins.int] = None,
                 rpc_send_transaction_also_leader: Optional[builtins.bool] = None,
                 rpc_send_transaction_retry_pool_max_size: Optional[builtins.int] = None,
                 rpc_send_transaction_tpu_peer: Optional[Sequence[builtins.str]] = None,
                 rpc_threads: Optional[builtins.int] = None,
                 skip_preflight_health_check: Optional[builtins.bool] = None,
                 skip_seed_phrase_validation: Optional[builtins.bool] = None,
                 skip_startup_ledger_verification: Optional[builtins.bool] = None,
                 snapshot_archive_format: Optional[builtins.str] = None,
                 snapshot_interval_slots: Optional[builtins.int] = None,
                 snapshot_packager_niceness_adjustment: Optional[builtins.int] = None,
                 snapshot_version: Optional[builtins.str] = None,
                 staked_nodes_overrides: Optional[builtins.str] = None,
                 tower_storage: Optional[builtins.str] = None,
                 tpu_coalesce_ms: Optional[builtins.int] = None,
                 tpu_connection_pool_size: Optional[builtins.int] = None,
                 tpu_disable_quic: Optional[builtins.bool] = None,
                 tpu_enable_udp: Optional[builtins.bool] = None,
                 tvu_receive_threads: Optional[builtins.int] = None,
                 unified_scheduler_handler_threads: Optional[builtins.int] = None,
                 use_snapshot_archives_at_startup: Optional[builtins.str] = None,
                 wait_for_supermajority: Optional[builtins.int] = None):
...
class ShutdownPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_delinquent_stake: Optional[builtins.int] = None,
                 min_idle_time: Optional[builtins.int] = None,
                 skip_health_check: Optional[builtins.bool] = None,
                 skip_new_snapshot_check: Optional[builtins.bool] = None):
...
class StartupPolicy(dict):
    ...
    def __init__(__self__, *,
                 wait_for_rpc_health: Optional[builtins.bool] = None):
    ...
    def wait_for_rpc_health(self) -> Optional[builtins.bool]:
...
class TimeoutConfig(dict):
    ...
    def __init__(__self__, *,
                 rpc_service_timeout: Optional[builtins.int] = None):
    ...
    def rpc_service_timeout(self) -> Optional[builtins.int]:
