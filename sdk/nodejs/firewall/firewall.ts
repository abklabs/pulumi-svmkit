...
export class Firewall extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'svmkit:firewall:Firewall';
    ...
    declare public readonly params: pulumi.Output<outputs.firewall.FirewallParams>;
...
export interface FirewallArgs {
    ...
    params: pulumi.Input<inputs.firewall.FirewallParamsArgs>;
